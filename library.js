...
(function (module) {
	...
	*/
	...
	const constants = Object.freeze({
		...
		name: 'gaiaform',	// Something unique to your OAuth provider in lowercase, like "github", or "nodebb"
		oauth2: {
			authorizationURL: 'https://gaiaform.io/oauth2/authorize',
			tokenURL: 'https://gaiaform.io/oauth2/token',
			clientID: nconf.get('oauth:id'),	// don't change this line
			clientSecret: nconf.get('oauth:secret'),	// don't change this line
		},
		userRoute: 'https://gaiaform.io/api/account',	// This is the address to your app's "user profile" API endpoint (expects JSON)
	});
	...
	OAuth.parseUserReturn = function (data, callback) {
		...
		var user = data.user;
		profile.id = user._id;
		profile.displayName = user.account.username;
		profile.emails = [{ value: user.account.email }];

		// Do you want to automatically make somebody an admin? This line might help you do that...
		profile.isAdmin = data.authority === "admin";
